...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\sipgateffx on
     Windows, /home/user/dev/sipgateffx on Linux) in a file named
     sipgateffx@michael.rotmanov and copy that file to
