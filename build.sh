...
ROOT_DIRS='modules components'  # ...and these directories       (space separated list)
...
if [ ! -d $TMP_DIR ]; then
  echo "Couldn't create $TMP_DIR and its parents."
  echo "Maybe not enough permissions?"
  exit;
fi
...
echo " "
echo "********************************************"
echo "Use $APP_NAME.xpi for distribution"
echo "********************************************"
